$(function(){
    ...
    $( "#rec_Date" ).datepicker({
      ...
      onClose: function( selectedDate ) {
        $( "#matt_Date" ).datepicker( "option", "minDate", selectedDate );

      }
    });
    $( "#matt_Date" ).datepicker({
      maxDate: maxDater,
      defaultDate: "+1w",
      changeMonth: true,
      numberOfMonths: 1,
      onClose: function( selectedDate ) {
        //$( "#rec_Date" ).datepicker( "option", "maxDate", selectedDate );
        $( "#act_Date" ).datepicker( "option", "minDate", selectedDate );
      }
    });
    ...
    $( "#act_Date" ).datepicker({
      ...
      numberOfMonths: 1,
      onClose: function( selectedDate ) {
        //$( "#matt_Date" ).datepicker( "option", "maxDate", selectedDate );
      }
    });
    ...
    function sendVerifiedForProcessing(code)
    {
        ...
        $.get("functions/processing_verified_data_inside.php?"+str+"&save_code="+code,function(data){
            if(data.length >0) {
